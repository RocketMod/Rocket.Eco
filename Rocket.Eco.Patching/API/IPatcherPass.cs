...
namespace Rocket.Eco.Patching.API
{
    public interface IPatcherPass
    {
        ...
        /// <returns><value>false</value> wwhen the patch is already registered, else <value>true</value>.</returns>
        ...
        /// <returns><value>false</value> when the requested <see cref="AssemblyDefinition"/> has no awaiting <see cref="IAssemblyPatch"/>, else <value>true</value>.</returns>
