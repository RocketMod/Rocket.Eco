...
namespace Rocket.Eco.Extensions
{
    public static class Vector3Extensions
    {
        ...
        public static SystemVector3 ToSystemVector3(this EcoVector3 vector)
            => new SystemVector3(vector.x, vector.y, vector.z);
        ...
        public static EcoVector3 ToEcoVector3(this SystemVector3 vector)
            => new EcoVector3(vector.X, vector.Y, vector.Z);
    }
}