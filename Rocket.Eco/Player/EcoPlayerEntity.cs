...
namespace Rocket.Eco.Player
{
    ...
    public sealed class EcoPlayerEntity : IPlayerEntity<EcoPlayer>
    {
        ...
        /// <inheritdoc />
        public Vector3 Position => Player.IsOnline
            ? Player.InternalEcoUser.Position.ToSystemVector3()
        ...
        public Task<bool> TeleportAsync(Vector3 position, float rotation)
        {
            ...
            Player.InternalEcoPlayer.SetPositionAndRotation(position.ToEcoVector3(),
                Quaternion.ToQuaternion(new Vector3(0, 0, rotation).ToEcoVector3()));
